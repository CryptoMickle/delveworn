...
export type SaveEnvelope = { version: 3; rules: "mind-beneath-2"; runId: string; seed: number; revision: number; journal: JournalEntry[]; checksum: string };
